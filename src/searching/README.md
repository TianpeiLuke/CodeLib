...
1. __Pre-order Traversal__, __In-order Traversal__, __Post-order Traversal__
   ...
   1. _In-order Traversal_ implements using a stack to keep track of an __entire__ left sub-tree and backtracking _only when_ no left sub-tree exists on __unvisited__ nodes. After visit of root, track the root of right sub-tree. 
