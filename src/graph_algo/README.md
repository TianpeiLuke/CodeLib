...
## Graph Search Algorithms
   ...
   3. __Topological Ordering and Topological Sort__
    ...
    Implemented using augmented visit list, with three states: 
      
    1. 0=un-visited, 
 
    2. 1=visited-but neighbors unfinished,  
    
    3. 2=visited-all neighbors finished. Return the reverse order for nodes turning to state=2;
